...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        ALTER TABLE sales ADD COLUMN payment_status TEXT NOT NULL DEFAULT 'paid' CHECK (payment_status IN ('paid', 'pending', 'partial'));
        RAISE NOTICE '✅ Columna payment_status agregada a sales';
    ELSE
        RAISE NOTICE '⚠️ Columna payment_status ya existe en sales';
    END IF;
    ...
    IF NOT EXISTS (
        ...
        RAISE NOTICE '✅ Columna change_amount agregada a sales';
    ELSE
        RAISE NOTICE '⚠️ Columna change_amount ya existe en sales';
    END IF;
    ...
    IF NOT EXISTS (
        ...
        RAISE NOTICE '✅ Columna payments agregada a sales';
    ELSE
        RAISE NOTICE '⚠️ Columna payments ya existe en sales';
    END IF;
END $$;
...
-- ✅ Columna payment_status agregada a sales
-- ✅ Columna paid_amount agregada a sales
-- ✅ Columna items agregada a sales
-- ✅ Columna change_amount agregada a sales
-- ✅ Columna payments agregada a sales
